...
def get_aqi(city):
    ...
    api_key = "dee46c46dd9a48558f1f15c28c31988b"  # Replace with your actual Weatherbit API key
    ...
    try:
        ...
        if "data" in data and data["data"]:
            ...
            if aqi is not None:
                ...
                result = f"AQI at ({latitude}, {longitude}): {aqi} ({aqic}), PM2.5: {pm25}, PM10: {pm10}, O3: {o3}, SO2: {so2}"
